...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Hola desde la Universidad de Xicotepec de Juarez Puebla, esta aplicacion fue creada por Irvingl';
...
const HelloWorldIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'irving';
    },
   handle(handlerInput) {
    ...
    switch (pregunta) {
      case 'cual es tu nombre':
        speechText = 'Mi nombre es Irving Morales.';
        break;
      ...
      case 'cual es tu color favorito':
        speechText = 'Mi color favorito es el Naranja.';
        break;
      case 'cual es tu grupo o cantante favorito':
        speechText = 'Me encanta el pop uno de mis grupos favoritos es Imaging Dragons.';
        break;
      default:
